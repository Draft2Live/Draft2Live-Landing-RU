...
export function generateMetadata(): Metadata {
  ...
  return {
    metadataBase: new URL('https://ru.draft2live.com'),
    ...
    openGraph: {
      ...
      url: 'https://ru.draft2live.com/',
      siteName: 'Draft2Live',
      locale: 'ru_RU',
      type: 'website',
      images: [{
        url: '/og-images/og-ru-v2.png',
        width: 1200,
        height: 630,
        type: 'image/png',
        alt: 'Draft2Live — публикация с ИИ напрямую в CMS',
      }],
    },
    twitter: {
...
function getJsonLd() {
  ...
  const orgSchema = {
    ...
    name: 'Draft2Live',
    url: 'https://ru.draft2live.com',
    logo: 'https://ru.draft2live.com/og-images/og-ru-v2.png',
